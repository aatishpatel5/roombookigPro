...
const [isSubmittingReview, setIsSubmittingReview] = useState(false)
  ...
  const reviweSubmitHandler = async () => {
  ...
  return (
    <div className="container mx-auto px-2 md:px-4 py-10">
      <div className="grid md:grid-cols-12 gap-10">
        <div className="hidden md:block md:col-span-4 lg:col-span-3 shadow-lg h-fit sticky top-10 bg-[#b4b4b4] text-black rounded-lg px-6 py-4">
      ...
      reviewSubmitHandler={reviweSubmitHandler}
      toggleRatingModal={toggleRatingModal}
      />
